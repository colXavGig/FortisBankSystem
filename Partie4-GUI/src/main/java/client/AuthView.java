...
public class AuthView extends JPanel {
	 ...
	 */
	public AuthView(MainFrame parent) {
		init(parent);
	}

	public AuthView(MainFrame parent, LayoutManager layout) {
		super(layout);
		init(parent);
	}

	public AuthView(MainFrame parent, boolean isDoubleBuffered) {
		super(isDoubleBuffered);
		init(parent);
	}

	public AuthView(MainFrame parent, LayoutManager layout, boolean isDoubleBuffered) {
	...
	private void init(MainFrame parent) {
		...
		loginBtn.setBounds(217, 200, 89, 23);
		add(loginBtn);
		...
		registerBtn.setBounds(87, 200, 89, 23);
		add(registerBtn);
	...
	private void login() {
		...
		try {
			...
			if (client != null) {
				parentFrame.showClientDashboard(client);
