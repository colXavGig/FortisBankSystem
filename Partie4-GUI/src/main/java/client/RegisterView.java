...
public class RegisterView extends JPanel {
	 ...
	 */
	public RegisterView(MainFrame parent) {
		init(parent);
	}

	public RegisterView(MainFrame parent, LayoutManager layout) {
		super(layout);
		init(parent);
	}

	public RegisterView(MainFrame parent, boolean isDoubleBuffered) {
		super(isDoubleBuffered);
		init(parent);
	}

	public RegisterView(MainFrame parent, LayoutManager layout, boolean isDoubleBuffered) {
